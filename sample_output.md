...
Yersinia pestis is the etiological agent of plague, alternatively growing in fleas or warm-blood mammals .

Fleas acquire this organism via blood meal from a bacteremic mammal, usually a rodent.

To produce a transmissible infection, Y. pestis colonizes the flea midgut and forms a biofilm in the proventricular valve optimally at 20 to 26°C, blocking its normal blood feeding .
...
However, a few bacilli are taken up by tissue macrophages, providing a fastidious and unoccupied niche for Y. pestis to synthesize virulence determinants .

Residence in this niche also facilitates the bacteria's resistance to phagocytosis .
...
A DNA microarray is able to determine simultaneous changes in all the genes of a cell at the mRNA level .

We and others have measured the gene expression profiles of Y. pestis in response to a variety of stimulating conditions (stimulon analysis), including temperature alteration tolerance , increased osmolarity , ion deficiency , antibiotic treatment , oxidative and acidic stresses , antibacterial peptide treatment  and nutrition limitation.

We also identified the regulons controlled by each of the regulatory proteins, Fur , PhoP , OmpR, and OxyR, by comparing the gene expression patterns of the mutant transcriptional regulator with that of its parental strain.

In order to acquire more regulatory information, all available microarray data of Y. pestis including those published signature expression profiles  were collected and subjected to clustering analysis, which infers functionality to the clusters of co-regulated genes.
...
Comprehensive analysis of large sets of microarray expression data is useful to dissect bacterial adaptation to various environments and to understand bacterial gene transcriptional regulation .

For example, Kendall and his colleagues have compared the general responses of *Mycobacterium tuberculosis* induced by a variety of different in vitro conditions (low pH, low nutrients, nitrogen, oxygen stress, stationary phase, and nutrition starvation) .

After the determination of the CsrA, SlyA, and PhoPQ regulons in Samonella typhimurium, the relevant regulon members are monitored to define the synergetic or antagonistic roles between these three regulators in cell infection models .

Recently, many signature expression profiles of Y. pestis have been reported .
...
Y. pestis possesses a set of virulence determinants that promote infection in mammalian hosts and/or transmission by flea vectors, and different virulence genes have been proven or proposed to be involved in different infection stages (reviewed in ).
...
For example, the hemin storage locus, hmsHFRS , was repressed by temperature upshift, high osmolarity, nutrition limitation, and streptomycin treatment.

The ymt gene encoding *Yersinia murine* toxin  was also regulated by temperature upshift and streptomycin treatment.

Y. pestis synthesizes several antiphagocytic factors, including F1 capsular antigen , pH6 antigen  and *Yersinia outer* proteins (Yops) .
...
F1 capsular antigen is expressed much more at 37°C than at 26°C .

pH6 antigen (PsaA), encoded by the chromosomal psaA gene, expresses in vitro between pH 5 and 6.7 at 35 to 41°C , or when bacteria live within phagocytic phagolysome .

The psaEFABC operon encodes a chaperone/usher pathway involved in the secretion and assembly of pH6 antigen as a polymer (fimbriae) on the surface of Y. pestis in macrophages .

PsaE is thought to be a positive regulator of the psaABC locus and is required for maximal expression of the pH6 antigen .

A recent study showed that the psaEFABC locus is regulated by RovA .
...
Most approaches for prokaryotic operon prediction were developed on the basis of genomic and/or phylogenetic information .
...
There was good agreement between our results and a recent report in which the adjacent genes of Y. pestis CO92 are predicted to be within an operon based on the greater conservation of operons in multiple species .
...
This process provides much greater insight into functional classes of co-expressed genes, since genes that are functionally related should be co-regulated and consequently should show similar expression profiles .
...
We analyzed the expression data with unsupervised algorithms and identified four clusters of co-expressed genes that were associated with ribosome biosynthesis, iron/heme assimilation, and sulfur and energy metabolism.
...
Genes in category A (yfe, hmu, yfu, ybt, and the tonB-exbB-exbD loci) are experimentally proven to be involved in iron/heme assimilation in Y. pestis .
...
*Those* genes in category A and B were also found to be iron-responsive in the previously published expression data .

However, category C consisted of the yacK and yhhN-zntA genes that are functionally related to metal metabolism; sufABCDSE that encodes constituents of Fe-S cluster assembly ; nrdHIEF which is responsible for glutaredoxin and ribonucleoside-diphosphate reduction ; and some genes (YPO0284, YPO0988, YPO1003, YPO2136, YPO1735, YPO1854-1856, YPO3339) without any functional information.
...
Genes responsible for sulfur uptake and utilization constitute the cys regulon in Gram-negative bacteria .
...
These results indicated a general retardation of energy generation in Y. pestis might occur in response to these suboptimal growth conditions.
...
The subsequent motif discovery analysis indicated the presence of DNA motifs that resembled the experimentally proved Fur, PurR, CRP, and Fnr boxes of E. coli and other bacteria , respectively.
...
It is very similar to the E. coli PurR box (5'-ANGMAAACGTTTNCGTK-3') .

A 21 bp box (5'-TGATAATGATTATCATTATCA-3') was found for the 19 genes in cluster II.

It is a 10-1-10 inverted repeat that resembles the E. coli Fur box (5'-GATAATGATAATCATTATC-3') .

A 15 bp box (5'-TGANNNNNNTCAA-3') was found within the upstream regions of the cluster III genes.

It is a part of the E. coli Fnr box (5'-AAWTTGATNWMNATCAAWWWW-3') .
...
It is a part of the binding boxes of CRP  and Fnr .

Previous DNA-binding studies showed that CRP bound to exactly the same sequence as that recognized by Fnr .

The ArcA regulator can recognize a relatively conservative sequence (5'-GTTAATTAA-3') .
...
Our study gave some hints to the possible function of uncharacterized genes and regulatory elements of Y. pestis such as operons and DNA regulatory motifs.
...
Y. pestis strain 201, avirulent to humans, belonging to a newly established biovar, Microtus , was grown at 26°C in a chemically defined TMH medium  to the middle exponential growth phase (A620 nm approximately 0.8).
...
The genome-wide transcriptional changes upon the environmental perturbations were monitored by the standard dual-fluorescent hybridization method with a Y. pestis whole-genome DNA microarray spotted with PCR-amplified ORFs .
...
Y. pestis mutants were engineered by replacing the gene targeted for deletion with a Kmr encoding cassette via λ-red phage homologous recombination as described previously .
...
The data filtering, normalization and significance analysis were done as described previously .
...
All the microarray data was deposited in Gene Expression Omnibus (GEO accession number GSE9279).
...
Genes were clustered according to their expression patterns in the twenty-five different experiments using Cluster 3.0 software .
...
For the original and the filtered data, self-organizing map (SOM) program first ran on the whole microarray dataset to cluster the genes based on the similarity of their expression profiles.

The output files were then processed by hierarchical clustering by using the average linkage method.

Correlation coefficients of more than 0.6 were arbitrarily extracted and visualized with TreeView  to graphically display the data by coloring each cell on the basis of the fluorescence ratio.
...
Promoter-proximate DNA sequences (400 bp upstream to 50 bp downstream of the start codon of each single-gene transcriptional unit, or the first gene of each operon) were retrieved from the genomic sequence of Y. pestis 91001 with the retrieve-sequence tool .

Collections of promoter sequences from co-expressed genes within each cluster were searched for potential regulatory DNA motifs with the multiple expectation maximization for motif elicitation (MEME) program .
...
Then, the sequence logos were built by compilation of the conserved sequences detected in the analysis for each motif with the WebLogo program .

Finally, PSSM for each DNA motif were built with the consensus and convert-matrix tools .
...
EMSA was performed using the Gel Shift Assay Systems (Promega, Madison, WI).
